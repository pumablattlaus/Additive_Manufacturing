...
class Control_ur_helper():
    ...
    def __init__(self,base_node):
        ...
        self.base_node.ur_twist_publisher = rospy.Publisher(self.ur_command_topic, Twist, queue_size=1)
    ...
    def setup_ddynamic_reconfigure(self):
        ...
        ddynrec.add_variable("ur_acceleration_limit", "float/double variable", 0.1, 0, 2.0)
        ddynrec.add_variable("Kpx", "float/double variable", -0.4, -1.0, 1.0)
        ddynrec.add_variable("Kpy", "float/double variable", -0.4, -1.0, 1.0)
